...
export const metadata = createMetadata({ title: "Contact Calculus Solver", description: "Contact Calculus Solver about incorrect answers, accessibility, privacy, or general support.", path: "/contact", indexable: false });
